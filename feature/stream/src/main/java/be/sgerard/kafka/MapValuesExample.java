...
public class MapValuesExample {
    ...
    public static Topology createTopology() {
        ...
        final KStream<String, Object> wordCounts = textLines
                .mapValues(textLine -> textLine.toUpperCase()); // stateless, no re-partitioning;

        wordCounts.to("stream-example-map-values");
