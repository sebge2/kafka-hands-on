...
public class MapExample {
    ...
    private static Topology createTopology() {
        ...
        final KStream<String, Object> wordCounts = builder.
                <String, String>stream("word-count-input")
                .map((key, value) -> new KeyValue<>(UUID.randomUUID().toString(), value)); // stateless, re-partitioning;

        wordCounts.to("stream-example-map");
