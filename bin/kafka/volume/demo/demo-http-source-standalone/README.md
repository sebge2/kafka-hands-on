...
- Execute `kafka-topics --create --topic demo-http-source-standalone --partitions 3 --replication-factor 1 --bootstrap-server kafka-broker-1:9092`
...
- Execute `cd ../../..`
- Execute `./execute_on_first_kafka_conect.sh`
- Execute `connect-standalone /demo/demo-http-source-standalone/worker.properties /demo/demo-http-source-standalone/http-stream-demo-standalone.properties`
- Exit container `CTRl + D`
